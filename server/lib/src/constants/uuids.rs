...
pub const UUID_IDM_PEOPLE_SELF_IMAGE_WRITE: Uuid = uuid!("00000000-0000-0000-0000-000000000059");
...
pub const UUID_SCHEMA_ATTR_OAUTH2_CLIENT_ID: Uuid = uuid!("00000000-0000-0000-0000-ffff00000203");
...
pub const UUID_SCHEMA_ATTR_OAUTH2_CLIENT_SECRET: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000207");
...
pub const UUID_SCHEMA_CLASS_OAUTH2_CLIENT: Uuid = uuid!("00000000-0000-0000-0000-ffff00000210");
...
pub const UUID_IDM_ACP_PEOPLE_SELF_WRITE_IMAGE: Uuid = uuid!("00000000-0000-0000-0000-ffffff000081");
